        ...
        <div className="order-2 md:order-1 w-full md:w-1/2 md:mt-32 mt-12 ">
          <div className="space-y-12 ">
            <h1 className="text-bold text-4xl">
              Hello, welcomes hers to learn something{" "}
              <span className="text-pink-500">new everyday!!!</span>
            </h1>
            <p className="text-xl ">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima
              reiciendis doloribus, temporibus placeat qui officiis deserunt
              enim saepe unde consectetur error natus!
            </p>
          ...
          <button className="btn mt-6 btn-secondary">More Info</button>
        </div>
